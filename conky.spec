...
Version  : 1.19.8
Release  : 17
URL      : https://github.com/brndnmtthws/conky/archive/v1.19.8/conky-1.19.8.tar.gz
Source0  : https://github.com/brndnmtthws/conky/archive/v1.19.8/conky-1.19.8.tar.gz
...
%prep
%setup -q -n conky-1.19.8
cd %{_builddir}/conky-1.19.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708989198
mkdir -p clr-build
pushd clr-build
...
/usr/share/doc/conky-1.19.8_pre/conky.conf
/usr/share/doc/conky-1.19.8_pre/conky_no_x11.conf
/usr/share/doc/conky-1.19.8_pre/convert.lua
