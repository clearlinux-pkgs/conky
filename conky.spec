...
Version  : 1.12.1
Release  : 8
URL      : https://github.com/brndnmtthws/conky/archive/v1.12.1/conky-1.12.1.tar.gz
Source0  : https://github.com/brndnmtthws/conky/archive/v1.12.1/conky-1.12.1.tar.gz
...
%prep
%setup -q -n conky-1.12.1
cd %{_builddir}/conky-1.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1615507815
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/conky-1.12.1/3rdparty/toluapp/COPYRIGHT %{buildroot}/usr/share/package-licenses/conky/9dcaf12014ad45c0f3a231eeda56550b1a4f094e
cp %{_builddir}/conky-1.12.1/LICENSE %{buildroot}/usr/share/package-licenses/conky/8624bcdae55baeef00cd11d5dfcfa60f68710a02
pushd clr-build
%make_install
popd
...
/usr/share/doc/conky-1.12.1_pre/conky.conf
/usr/share/doc/conky-1.12.1_pre/conky_no_x11.conf
/usr/share/doc/conky-1.12.1_pre/convert.lua
