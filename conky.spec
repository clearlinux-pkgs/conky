...
Version  : 1.16.1
Release  : 10
URL      : https://github.com/brndnmtthws/conky/archive/v1.16.1/conky-1.16.1.tar.gz
Source0  : https://github.com/brndnmtthws/conky/archive/v1.16.1/conky-1.16.1.tar.gz
...
%prep
%setup -q -n conky-1.16.1
cd %{_builddir}/conky-1.16.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672167565
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/conky-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/conky/8624bcdae55baeef00cd11d5dfcfa60f68710a02
pushd clr-build
%make_install
popd
...
/usr/share/doc/conky-1.16.1_pre/conky.conf
/usr/share/doc/conky-1.16.1_pre/conky_no_x11.conf
/usr/share/doc/conky-1.16.1_pre/convert.lua
